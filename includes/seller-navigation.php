...
session_start();
$shop_id = $_SESSION['id'];
$unread_sql = $dbconnnect->query("SELECT * FROM chat_message WHERE to_user_id = '$shop_id' AND status = '1'");
...
<nav class="navbar navbar-default navbar-fixed-top">
	<div class="container-fluid">
		...
		<a class="navbar-brand" href="SellerHomepage.php"><span style=
			"
			font-family: 'Open Sans', sans-serif;
			 font-weight: 400;
			 font-size: 25px;
			 margin-left: 30px;
			 ">Arkimorma Rentee</span></a>
		</div>
		...
		<ul class="nav navbar-nav navbar-right">
			<li ><a href="SellerChatIndex.php"><span style="font-size: 20px;"  class="glyphicon glyphicon-envelope"></span>
				<?php 
				if ($unread != 0) {
					echo'<span style="background:red; margin-left:-10px; margin-top:-10px; position:absolute;" class="badge badge-warning">'.$unread.'</span>';
				}

			?></a></li>
			<li><a href="SellerUploadingProduct.php">Post New Product</a></li>
			<li><a href="SellerMyIncome.php">My Income</a></li>
			<li><a href="SellerMyStore.php">Products</a></li>
			<li><a href="SellerRent.php?update=true">Rent</a></li>
			
		
			<li><a href="SellerHomepage.php?logout=true">Logout</a></li>
		</ul>
		</div><!-- /.navbar-collapse -->
	</div><!-- /.container-fluid -->
</nav>