...
$error = NULL;
	...
	if (isset($_POST['sendemail'])) {
		...
		//check email 
		$sql = "SELECT * FROM sellers WHERE email = '$useremail'";
		...
		if($result->num_rows ==0) {
			...
			//send email
			$to = $useremail;
			$subject = "ARKIMORMA Reset Password";
			$message = "<html>
				<head>
				<title>Arkimorma - Reset Password</title>
				</head>
				<body>
				<h2>Arkimorma - Reset Password.</h2>
				<p>Hi! ".$username."</p>
				<p>Forgot your password? We receive a request to reset the password for your account.
				<br><br>Please click the link below to Reset your account.</p>
				<h4><a href = 'http://localhost/ark/seller/SellerResetpass.php?email=$useremail'>Reset Password</h4>
				</body>
				</html>";
			...
			myAlert("We send a link to your Email. Please Check to reset Password", "SellerLogin.php");
...
<head>
	<meta charset="utf-8">
	<title>Arkimorma | Seller-Forgot Password</title>
	...
	<?php include('includes/navigation.php'); ?>
		<div class="EmailReset">
			<div class="form-container">
				<form action="#" method="POST" class="form-wrap" action="UserForgotPassword.php">
					<h4>Enter Your Email Here to Reset Password</h4>
					<?php 
						echo "<h5 style='color: #000;'> ".$error."</h5>";
					 ?>
						<div class="form-box">
							
							<input type="text" name="email" placeholder="Enter Email">
							<input type="submit" name="sendemail" value="Enter">
						</div>
						<br>
					<div class="text-center">
						<a href="SellerLogin.php"class="btn btn-danger">Back</a>
					</div>
				</form>
			</div>
		</div>
