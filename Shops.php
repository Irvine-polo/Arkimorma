...
<body>
    ...
    <div class="main-container">
		...
		<div class="HomepageAbout" style="position: relative; ">
			<img class="image" src="assets/images/banner.jpg" alt="">
			<div class="text-center" style="width: 100%;  position: absolute; top: 50%; left: auto; right: auto;">
				<a href="About.php" class="btn btn-lg btn-default">About Us</a>
			</div>
		</div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-3 shops-categories">
                    ...
                    <div>
                        <ul>
                            <li><a href="#"><h4>Pending<h4></a></li>
                            <li><a href="#"><h4>Approved<h4></a></li>
                            <li><a href="#"><h4>Ready to Pick<h4></a></li>
                            <li><a href="#"><h4>To Rate<h4></a></li>
                            <li><a href="#"><h4>Cancelled<h4></a></li>
                        </ul>
                    </div>
                </div>
                <!-- CATEGOIES -->
                    ...
                    <div class="shops-sort row">
                        ...
                        <div class="row ">
                            ...
                            <a href="#">
                                <div class="shops-item col-xs-4">
                                    <div class="image">
                                        <img src="assets/images/shop5.jpg" alt="">
                                    </div>
                                    <div class="shop-name">
                                        <h5>SHOP NAME4</h5>
                                    </div>
                            ...
                            <a href="#">
                                <div class="shops-item col-xs-4">
                                    <div class="image">
                                        <img src="assets/images/shop6.jpg" alt="">
                                    </div>
                                    <div class="shop-name">
                                        <h5>SHOP NAME4</h5>
                                    </div>
				...
				<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner" role="listbox">
						...
						<div class="item active">
							<div class="row">
								<a href="">
									<div class="popular-item col-xs-4">
										<div class="image">
											<img src="assets/images/popular1.jpg" alt="">
										</div>
										<div class="popular-name">
											<h5 class="">POPULAR SHOP NAME1</h5>
										</div>
									</div>
								</a>
								...
								<a href="">
									<div class="popular-item col-xs-4">
										...
										<div class="popular-name">
											<h5 class="">POPULAR SHOP NAME2</h5>
										</div>
									</div>
								</a>
								...
								<a href="">
									<div class="popular-item col-xs-4">
										...
										<div class="popular-name">
											<h5 class="">POPULAR SHOP NAME3</h5>
										</div>
									</div>
								</a>
							</div>
							...
							<div class="row">
								<a href="">
									<div class="popular-item col-xs-4">
										...
										<div class="popular-name">
											<h5 class="">POPULAR SHOP NAME4</h5>
										</div>
									</div>
								</a>
								...
								<a href="">
									<div class="popular-item col-xs-4">
										<div class="image">
											<img src="assets/images/popular5.jpg" alt="">
										</div>
										<div class="popular-name">
											<h5 class="">POPULAR SHOP NAME5</h5>
										</div>
									</div>
								</a>
								...
								<a href="">
									<div class="popular-item col-xs-4">
										<div class="image">
											<img src="assets/images/popular6.jpg" alt="">
										</div>
										<div class="popular-name">
											<h5 class="">POPULAR SHOP NAME6</h5>
										</div>
									</div>
								</a>
							</div>
