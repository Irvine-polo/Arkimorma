...
<head>
	...
	<title>Arkimorma | User-Reset Password</title>
...
<body>
	 ...
	 <div class="container">
	 <form method="POST" action="UserResetpass.php?email=<?php echo $userEmail ?>">
		<h3> Reset Password</h3>
		<br><br><br>
		<label for="password"><b>Password : </b> <input type="password" name="password"></label>
		<label for="retype-Password"><b>Retype-Password : </b> <input type="password" name="retype-password"></label>
