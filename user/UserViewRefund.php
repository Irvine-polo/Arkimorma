...
<style type="text/css">
 ...
 <body>
	...
	if (isset($_GET['order_id'])) {
		$id = $_GET['order_id'];
		$sql = $dbconnnect->query("SELECT product_name,total,order_time,account_name,account_email,refund_proof FROM order_table WHERE order_id = '$id'");
		...
		<div class="container">
			...
			<img src="<?php echo$dir.$proof['refund_proof']; ?>">
