...
if (isset($_POST['Contact'])) {
	...
	$arki_email = $dbconnnect->query("SELECT email FROM admin");
	$row = $arki_email->fetch_assoc();
	$arki_email = $row['email'];
	
	//email
		$to = $arki_email;
		$subject = "ARKIMORMA - MESSAGE";
		$message = "<html>
			<head>
			<title>$name</title>
			</head>
		...
		myAlert("Email Successfully","UserContact.php");
}
				...
				<div class="col-xs-8 col-xs-offset-2">
					<div class="row">
						<div class=" col-sm-6">
							...
							<div class="box">
								<div class="text">
									<h4 class="text-left"><i class="fas fa-map-marker-alt"></i> Address</h4>
									<h5>Blk 10 Lot 33 Sameera Sapalibutad Angeles City Pampanga</h5>
								</div>
							</div>
							...
							<div class="box">
								<div class="text">
									<h4 class="text-left"><i class="fas fa-mobile-alt"></i> Phone</h4>
									<h5>09354120965</h5>
								</div>
							</div>
							...
							<div class="box">
								<div class="text">
									<h4 class="text-left"><i class="fas fa-envelope-open-text"></i> Email</h4>
									<h5>arkimorma@gmail.com</h5>
								</div>
							</div>      
						</div>
