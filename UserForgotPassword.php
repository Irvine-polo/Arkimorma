	...
	if (isset($_POST['sendemail'])) {
		...
		if($result->num_rows ==0) {
			...
			$message = "<html>
				...
				<h4><a href = 'http://localhost/ark/user/UserResetpass.php?email=$useremail'>Reset Password</h4>
				</body>
				</html>";
			...
			myAlert("We send a link to your Email. Please Check to reset Password", "UserLogin.php");
...
<head>
	<meta charset="utf-8">
	<title>Arkimorma | User-Forgot Password</title>
			...
			<div class="form-container">
				<form action="#" method="POST" class="form-wrap" action="UserForgotPassword.php">
					...
					<div class="text-center">
						<a href="UserLogin.php"class="btn btn-danger">Back</a>
					</div>
				</form>
			</div>
		</div>
